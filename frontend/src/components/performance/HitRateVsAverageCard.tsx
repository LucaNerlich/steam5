    ...
    return (
        <div className="perf-card">
            ...
            <svg viewBox={`0 0 ${width} 86`} className="perf-line" role="img" aria-label="Your hit rate vs global average">
                <Row y={18} label={'You (last 35)'} pct={myHitRate} color={'var(--color-primary, #6366f1)'} />
                <Row y={44} label={'All players'} pct={globalAvg ?? myHitRate} color={'var(--color-success, #16a34a)'} />
            </svg>
        </div>
    );
}
