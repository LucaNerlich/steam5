...
export default function PriceGuesserFooter() {
    return (
        <FooterShell className="footer--game footer--price">
            <div className="footer__meta">
                <small className="footer__meta-line text-muted">Price Guesser · coming soon</small>
