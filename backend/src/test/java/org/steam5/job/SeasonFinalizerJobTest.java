...
class SeasonFinalizerJobTest {
    ...
    void setUp() {
        ...
        job = new SeasonFinalizerJob(seasonService, leaderboardRefreshService);
    ...
    @Test
    void execute_refreshFails_isCaughtAndDoesNotPropagate() {
        ...
        // logged, never rethrown as JobExecutionException.
